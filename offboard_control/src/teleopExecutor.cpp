#include "offboard_control/teleopExecutor.hpp"
...
TeleopExecutor::TeleopExecutor(px4_ros2::ModeBase &owned_mode)
    : ModeExecutorBase(Settings{}, owned_mode), _node(owned_mode.node())
     {
...
{
    const char *reason_str = (reason == DeactivateReason::FailsafeActivated) ? "failsafe activated" : "other reason";
